...
const sampleMembers: Member[] = [
    {
        ...
        position: 'シニアエンジニア',
        skills: [
            { name: 'TypeScript', category: 'programming', level: 'expert', yearsOfExperience: 5 },
            { name: 'React', category: 'programming', level: 'advanced', yearsOfExperience: 4 },
    ...
    },
    {
        ...
        position: 'リードデザイナー',
        skills: [
            { name: 'UI/UXデザイン', category: 'design', level: 'expert', yearsOfExperience: 7 },
            { name: 'Figma', category: 'design', level: 'expert', yearsOfExperience: 5 },
            { name: 'Webデザイン', category: 'design', level: 'advanced', yearsOfExperience: 6 },
        ],
        currentProjects: [],
